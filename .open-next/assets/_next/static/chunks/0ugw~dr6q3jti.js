...
- 记录每次工具调用的参数与结果
- 保存用户请求和系统响应，用于追责
- 保留日志至少30天`},{type:"note",title:"成本与安全",content:"控制调用频率、设置权限、加密传输，以及按需扩缩容，是部署MCP时的常见策略。"}],summary:"企业级MCP部署需要关注高可用、监控、审计、安全和成本。通过冗余架构、日志审计和权限控制，才能在生产环境稳健运行。",keyPoints:["高可用架构包含冗余、负载均衡与故障切换","监控指标：响应时间、成功率、异常日志","审计记录请求/响应并保存30天以上"],exercises:[{type:"choice",question:"企业级MCP部署时，哪个要素最重要？",options:["颜色主题","高可用架构、监控与审计","更大的模型","把所有逻辑写在前端"],answer:"高可用架构、监控与审计",explanation:"部署MCP时，确保高可用和能够监控/审计是根本。"},{type:"choice",question:"MCP审计日志至少保留多久？",options:["1天","7天","30天","永远不删除"],answer:"30天",explanation:"审计日志需要保留下至少30天，便于追踪和合规。"}]}},g={"workflow-principles":{id:"workflow-principles",title:"工作流设计原则",subtitle:"学会设计可理解、可维护的AI工作流",duration:40,difficulty:"intermediate",tags:["Workflow","设计原则"],objectives:["理解工作流设计的核心原则","掌握流程控制和分支的基本方法","学会设计可复用的工作流模块"],sections:[{type:"introduction",title:"开篇：什么时候需要工作流？",content:"当单次AI回复不能完成多步任务时，就需要工作流。它通过一系列节点、分支和条件，让AI按既定流程执行任务，具备可维护和可观测性。"},{type:"concept",title:"设计原则一：原子性与可组合",content:`**原子性**：每个节点做一件事，如"查询用户"、"写报告"。职责清晰便于测试。
...
**聊天记录** → 按会话分割（每个对话独立）`}],summary:"文档切分策略包括固定长度、语义分割和滑动窗口。固定长度简单但可能割裂语义，语义分割保持完整但长度不一，滑动窗口通过重叠保证连续性。应根据文档类型选择合适策略。",keyPoints:["固定长度切分：简单，但可能割裂语义","语义切分：保持段落、句子完整，适合结构化文档","滑动窗口：片段有重叠，保证关键信息不断开","根据文档类型选择策略"],exercises:[{type:"choice",question:"滑动窗口切分的主要优势是？",options:["实现最简单","片段长度完全一致","片段之间有重叠，保证关键信息不被截断","不需要额外内存"],answer:"片段之间有重叠，保证关键信息不被截断",explanation:"滑动窗口让相邻片段有重叠，避免关键词被边界切断。"},{type:"choice",question:"哪种文档最适合用语义分割？",options:["无结构的长文本","有明确标题和结构的Markdown文档","代码片段","纯数字数据"],answer:"有明确标题和结构的Markdown文档",explanation:"语义分割利用文档的自然边界（标题、段落），对结构化文档效果好。"}]}},y={"rag-retrieval":{id:"rag-retrieval",title:"检索优化与重排序",subtitle:"提升RAG检索质量的实战技巧",duration:45,difficulty:"intermediate",tags:["RAG","检索优化","重排序"],objectives:["掌握检索质量优化的核心方法","学会使用重排序提升结果相关性","了解混合检索策略"],sections:[{type:"introduction",title:"开篇：为什么检索质量决定RAG效果",content:"RAG的效果上限由检索质量决定。如果检索到的文档不相关，即使最好的生成模型也无法给出正确答案。本节课我们将学习如何优化检索环节。"},{type:"concept",title:"检索优化的核心问题",content:`**问题一：语义鸿沟**
...
- 与监管机构保持沟通
- 参与行业自律组织
- 建立用户信任`},{type:"note",title:"治理是竞争优势",content:"良好的AI治理不是负担，而是竞争优势。它能降低合规风险、提升用户信任、获得监管认可，为企业长期发展奠定基础。"}],summary:"AI治理框架包括原则政策、流程控制、人员文化三大支柱。主要法规包括中国的生成式AI管理办法、个人信息保护法，欧盟AI法案等。企业需要建立治理委员会、风险评估机制、持续改进流程。",keyPoints:["AI治理三大支柱：原则政策、流程控制、人员文化","主要法规：中国生成式AI管理办法、欧盟AI法案、美国NIST框架","企业治理体系：委员会+安全团队+合规团队","持续治理：定期评估、事件响应、政策更新、对外沟通"],exercises:[{type:"choice",question:"欧盟AI法案禁止的AI类别不包括？",options:["社会评分系统","实时生物识别监控","邮件分类","潜意识操纵"],answer:"邮件分类",explanation:"欧盟AI法案禁止的是社会评分、实时生物识别监控等高风险AI。邮件分类属于有限风险或最小风险AI。"},{type:"choice",question:"AI风险评估应该何时进行？",options:["只在产品发布前","只在出现问题时","贯穿项目全生命周期，定期评估","不需要风险评估"],answer:"贯穿项目全生命周期，定期评估",explanation:"AI风险评估应该贯穿项目全生命周期，从开发到发布再到运行，都需要定期评估和监控。"}]}},I="ai_academy_learning_progress";function b(e){return e.completed}function w(){let e,o,s,r,a,c,l,p,d,m,u,g,f,y,_,A,h=(0,n.c)(30),{data:x,getCompletedCount:k}=function(){let e,t,o,s,r,a,c=(0,n.c)(11),[l,p]=(0,i.useState)(null);c[0]===Symbol.for("react.memo_cache_sentinel")?(e=()=>{let e=localStorage.getItem(I);if(e)try{p(JSON.parse(e))}catch{}},t=[],c[0]=e,c[1]=t):(e=c[0],t=c[1]),(0,i.useEffect)(e,t),c[2]===Symbol.for("react.memo_cache_sentinel")?(o=(e,t)=>{p(n=>{let o={userId:n?.userId||"anonymous",progress:{...n?.progress,[e]:{lessonId:e,completed:t.completed??n?.progress[e]?.completed??!1,completedAt:t.completed?new Date().toISOString():void 0,lastPosition:t.lastPosition??n?.progress[e]?.lastPosition,notes:t.notes??n?.progress[e]?.notes,bookmarks:t.bookmarks??n?.progress[e]?.bookmarks}},totalTime:n?.totalTime??0,streak:n?.streak??0,lastStudyDate:new Date().toISOString().split("T")[0]};return localStorage.setItem(I,JSON.stringify(o)),o})},c[2]=o):o=c[2];let d=o;c[3]!==l?.progress?(s=e=>l?.progress[e],c[3]=l?.progress,c[4]=s):s=c[4];let m=s;c[5]!==l?.progress?(r=()=>Object.values(l?.progress||{}).filter(b).length,c[5]=l?.progress,c[6]=r):r=c[6];let u=r;return c[7]!==l||c[8]!==u||c[9]!==m?(a={data:l,updateProgress:d,getProgress:m,getCompletedCount:u},c[7]=l,c[8]=u,c[9]=m,c[10]=a):a=c[10],a}();h[0]===Symbol.for("react.memo_cache_sentinel")?(e=(0,t.jsx)("h3",{className:"font-semibold text-gray-900 mb-4",children:"学习统计"}),h[0]=e):e=h[0],h[1]!==k?(o=k(),h[1]=k,h[2]=o):o=h[2],h[3]!==o?(s=(0,t.jsx)("p",{className:"text-2xl font-bold text-blue-600",children:o}),h[3]=o,h[4]=s):s=h[4],h[5]===Symbol.for("react.memo_cache_sentinel")?(r=(0,t.jsx)("p",{className:"text-sm text-blue-700",children:"已完成课程"}),h[5]=r):r=h[5],h[6]!==s?(a=(0,t.jsxs)("div",{className:"p-4 bg-blue-50 rounded-lg",children:[s,r]}),h[6]=s,h[7]=a):a=h[7];let P=x?.streak??0;h[8]!==P?(c=(0,t.jsx)("p",{className:"text-2xl font-bold text-purple-600",children:P}),h[8]=P,h[9]=c):c=h[9],h[10]===Symbol.for("react.memo_cache_sentinel")?(l=(0,t.jsx)("p",{className:"text-sm text-purple-700",children:"连续学习天数"}),h[10]=l):l=h[10],h[11]!==c?(p=(0,t.jsxs)("div",{className:"p-4 bg-purple-50 rounded-lg",children:[c,l]}),h[11]=c,h[12]=p):p=h[12];let w=Math.floor((x?.totalTime??0)/60);return h[13]!==w?(d=(0,t.jsx)("p",{className:"text-2xl font-bold text-emerald-600",children:w}),h[13]=w,h[14]=d):d=h[14],h[15]===Symbol.for("react.memo_cache_sentinel")?(m=(0,t.jsx)("p",{className:"text-sm text-emerald-700",children:"学习小时数"}),h[15]=m):m=h[15],h[16]!==d?(u=(0,t.jsxs)("div",{className:"p-4 bg-emerald-50 rounded-lg",children:[d,m]}),h[16]=d,h[17]=u):u=h[17],h[18]!==x?.progress?(g=Object.keys(x?.progress??{}),h[18]=x?.progress,h[19]=g):g=h[19],h[20]!==g.length?(f=(0,t.jsx)("p",{className:"text-2xl font-bold text-orange-600",children:g.length}),h[20]=g.length,h[21]=f):f=h[21],h[22]===Symbol.for("react.memo_cache_sentinel")?(y=(0,t.jsx)("p",{className:"text-sm text-orange-700",children:"学习课程数"}),h[22]=y):y=h[22],h[23]!==f?(_=(0,t.jsxs)("div",{className:"p-4 bg-orange-50 rounded-lg",children:[f,y]}),h[23]=f,h[24]=_):_=h[24],h[25]!==u||h[26]!==_||h[27]!==a||h[28]!==p?(A=(0,t.jsxs)("div",{className:"bg-white rounded-xl border border-gray-200 p-6",children:[e,(0,t.jsxs)("div",{className:"grid grid-cols-2 gap-4",children:[a,p,u,_]})]}),h[25]=u,h[26]=_,h[27]=a,h[28]=p,h[29]=A):A=h[29],A}function T(){let e,o=(0,n.c)(1);if(o[0]===Symbol.for("react.memo_cache_sentinel")){let n=Object.values(r);e=(0,t.jsxs)("div",{className:"bg-white rounded-xl border border-gray-200 p-6",children:[(0,t.jsx)("h3",{className:"font-semibold text-gray-900 mb-4",children:"学习路线图"}),(0,t.jsx)("div",{className:"space-y-4",children:n.map((e,o)=>(0,t.jsxs)("div",{className:"relative",children:[o<n.length-1&&(0,t.jsx)("div",{className:"absolute left-5 top-12 w-0.5 h-8 bg-gray-200"}),(0,t.jsxs)("div",{className:"flex items-start gap-4",children:[(0,t.jsx)("div",{className:`w-10 h-10 rounded-lg bg-gradient-to-r ${e.gradient} flex items-center justify-center text-white font-bold flex-shrink-0`,children:e.icon}),(0,t.jsxs)("div",{className:"flex-1",children:[(0,t.jsx)("h4",{className:"font-medium text-gray-900",children:e.title}),(0,t.jsx)("p",{className:"text-sm text-gray-500 mb-2",children:e.description}),(0,t.jsx)("div",{className:"flex flex-wrap gap-2",children:e.modules.map(v)})]})]})]},e.id))})]}),o[0]=e}else e=o[0];return e}function v(e){let n=a[e];return(0,t.jsx)(o.default,{href:`/learn/module/${e}`,className:"text-xs px-2 py-1 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded transition-colors",children:n?.title??e},e)}function j(e,n){return(0,t.jsx)("p",{className:"text-gray-700 leading-relaxed mb-4 last:mb-0",children:e},n)}function S(e,n){return(0,t.jsx)("p",{className:"text-gray-700 leading-relaxed mb-4 last:mb-0",children:e},n)}function N(e,n){return(0,t.jsx)("p",{className:"text-gray-700 leading-relaxed mb-4 last:mb-0",children:e},n)}let q=Object.values(r);function C(){let e,s,r,a,c,l,p,d,m=(0,n.c)(15),[u,g]=(0,i.useState)("stages");return m[0]===Symbol.for("react.memo_cache_sentinel")?(e=(0,t.jsxs)("div",{className:"mb-8",children:[(0,t.jsxs)("h1",{className:"text-3xl font-bold text-gray-900 mb-2 flex items-center",children:[(0,t.jsx)("span",{className:"mr-2",children:"📚"}),"AI博士学院"]}),(0,t.jsx)("p",{className:"text-gray-600",children:"系统学习 AI 能力平台，从入门到精通的完整学习路径"})]}),m[0]=e):e=m[0],m[1]===Symbol.for("react.memo_cache_sentinel")?(s=[{key:"stages",label:"学习阶段"},{key:"modules",label:"课程模块"},{key:"progress",label:"学习进度"}],m[1]=s):s=m[1],m[2]!==u?(r=(0,t.jsx)("div",{className:"flex gap-2 mb-8",children:s.map(e=>(0,t.jsx)("button",{onClick:()=>g(e.key),className:`px-4 py-2 rounded-lg font-medium transition-colors ${u===e.key?"bg-blue-600 text-white":"bg-gray-100 text-gray-600 hover:bg-gray-200"}`,children:e.label},e.key))}),a="stages"===u&&(0,t.jsx)("div",{className:"grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6",children:q.map(L)}),m[2]=u,m[3]=r,m[4]=a):(r=m[3],a=m[4]),m[5]!==u?(c="modules"===u&&(0,t.jsx)("div",{className:"space-y-8",children:q.map(R)}),m[5]=u,m[6]=c):c=m[6],m[7]!==u?(l="progress"===u&&(0,t.jsxs)("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[(0,t.jsxs)("div",{className:"space-y-6",children:[(0,t.jsx)(w,{}),(0,t.jsx)(T,{})]}),(0,t.jsxs)("div",{className:"bg-white rounded-xl border border-gray-200 p-6",children:[(0,t.jsx)("h3",{className:"font-semibold text-gray-900 mb-4",children:"学习建议"}),(0,t.jsxs)("div",{className:"space-y-4",children:[(0,t.jsxs)("div",{className:"p-4 bg-blue-50 rounded-lg border border-blue-200",children:[(0,t.jsx)("h4",{className:"font-medium text-blue-900 mb-2",children:"🎯 新手入门"}),(0,t.jsx)("p",{className:"text-sm text-blue-800",children:"建议从「AI本质与原理」开始，建立正确的AI认知，理解AI的真实工作方式。"}),(0,t.jsx)(o.default,{href:"/learn/lesson/ai-what-is",className:"mt-3 inline-block text-sm text-blue-600 hover:text-blue-700",children:"开始学习 →"})]}),(0,t.jsxs)("div",{className:"p-4 bg-green-50 rounded-lg border border-green-200",children:[(0,t.jsx)("h4",{className:"font-medium text-green-900 mb-2",children:"📚 系统学习"}),(0,t.jsx)("p",{className:"text-sm text-green-800",children:"按照阶段顺序学习：基础认知 → Prompt工程 → Agent开发 → RAG知识库 → 生产实践"})]}),(0,t.jsxs)("div",{className:"p-4 bg-purple-50 rounded-lg border border-purple-200",children:[(0,t.jsx)("h4",{className:"font-medium text-purple-900 mb-2",children:"💡 学习技巧"}),(0,t.jsx)("p",{className:"text-sm text-purple-800",children:"每节课都配有代码示例和练习题，动手实践是掌握知识的关键。"})]})]})]})]}),m[7]=u,m[8]=l):l=m[8],m[9]===Symbol.for("react.memo_cache_sentinel")?(p=(0,t.jsx)("div",{className:"mt-12 bg-linear-to-r from-blue-500 to-indigo-600 rounded-2xl p-8 text-white",children:(0,t.jsxs)("div",{className:"flex items-center justify-between",children:[(0,t.jsxs)("div",{children:[(0,t.jsx)("h2",{className:"text-2xl font-bold mb-2",children:"开始你的AI学习之旅"}),(0,t.jsx)("p",{className:"text-white/80",children:"从基础认知开始，逐步掌握AI应用开发的核心技能"})]}),(0,t.jsx)(o.default,{href:"/learn/lesson/ai-what-is",className:"px-6 py-3 bg-white text-blue-600 rounded-xl font-medium hover:bg-blue-50 transition-colors",children:"开始学习"})]})}),m[9]=p):p=m[9],m[10]!==r||m[11]!==a||m[12]!==c||m[13]!==l?(d=(0,t.jsxs)("div",{className:"p-8",children:[e,r,a,c,l,p]}),m[10]=r,m[11]=a,m[12]=c,m[13]=l,m[14]=d):d=m[14],d}function R(e){return(0,t.jsxs)("div",{children:[(0,t.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[(0,t.jsx)("div",{className:`w-8 h-8 rounded-lg bg-linear-to-r ${e.gradient} flex items-center justify-center text-white`,children:e.icon}),(0,t.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:e.title})]}),(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4",children:e.modules.map(M)})]},e.id)}function M(e){let n=a[e],i=function(e){let t,n=(Object.assign(t={},c),Object.assign(t,l),Object.assign(t,p),Object.assign(t,d),Object.assign(t,m),Object.assign(t,u),Object.assign(t,g),Object.assign(t,f),Object.assign(t,y),Object.assign(t,_),Object.assign(t,A),Object.assign(t,h),Object.assign(t,x),Object.assign(t,k),Object.assign(t,P),t),o=[];for(let t of Object.values(n))t.id.startsWith(e)&&o.push(t);return o.sort((e,t)=>e.id.localeCompare(t.id))}(e),r=s[n?.difficulty??"beginner"];return(0,t.jsxs)("div",{className:"bg-white rounded-xl border border-gray-200 overflow-hidden",children:[(0,t.jsx)("div",{className:`bg-linear-to-r ${n?.color??"from-gray-500 to-gray-600"} p-4 text-white`,children:(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsx)("div",{className:"w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center text-xl",children:n?.icon??"📚"}),(0,t.jsxs)("div",{children:[(0,t.jsx)("h3",{className:"font-bold",children:n?.title??e}),(0,t.jsxs)("p",{className:"text-xs text-white/80",children:[i.length,"节课"]})]})]})}),(0,t.jsxs)("div",{className:"p-4",children:[(0,t.jsx)("p",{className:"text-sm text-gray-600 mb-3",children:n?.description}),(0,t.jsxs)("div",{className:"flex items-center justify-between",children:[(0,t.jsx)("span",{className:`px-2 py-0.5 rounded text-xs font-medium ${r.bgColor} ${r.color}`,children:r.label}),(0,t.jsx)(o.default,{href:`/learn/module/${e}`,className:"text-sm text-blue-600 hover:text-blue-700",children:"查看课程 →"})]})]})]},e)}function L(e){return(0,t.jsxs)(o.default,{href:`/learn/path/${e.id}`,className:"group bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg hover:border-gray-300 transition-all",children:[(0,t.jsx)("div",{className:`bg-linear-to-r ${e.gradient} p-4 text-white`,children:(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsx)("div",{className:"w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center text-xl",children:e.icon}),(0,t.jsxs)("div",{children:[(0,t.jsx)("h3",{className:"font-bold",children:e.title}),(0,t.jsx)("p",{className:"text-sm text-white/80",children:e.subtitle})]})]})}),(0,t.jsx)("div",{className:"p-4 border-b border-gray-100",children:(0,t.jsx)("p",{className:"text-sm text-gray-600",children:e.description})}),(0,t.jsx)("div",{className:"p-4",children:(0,t.jsx)("div",{className:"space-y-2",children:e.modules.map(G)})})]},e.id)}function G(e){let n=a[e];return(0,t.jsxs)("div",{className:"flex items-center gap-2 text-sm",children:[(0,t.jsx)("span",{className:"w-5 h-5 rounded bg-gray-100 text-gray-500 text-xs flex items-center justify-center",children:n?.icon??"📚"}),(0,t.jsx)("span",{className:"text-gray-700",children:n?.title??e})]},e)}e.s(["default",0,C],5029),e.i(5029),e.s(["CodeSection",0,function(e){let o,s,r,a,c,l,p,d,m,u,g,f,y=(0,n.c)(30),{section:_,index:A}=e,[h,x]=(0,i.useState)(!1);y[0]!==_.code?(o=async()=>{_.code&&(await navigator.clipboard.writeText(_.code),x(!0),setTimeout(()=>x(!1),2e3))},y[0]=_.code,y[1]=o):o=y[1];let k=o,P=A+1;y[2]!==P?(s=(0,t.jsx)("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm",children:P}),y[2]=P,y[3]=s):s=y[3],y[4]!==_.title?(r=(0,t.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:_.title}),y[4]=_.title,y[5]=r):r=y[5],y[6]!==s||y[7]!==r?(a=(0,t.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[s,r]}),y[6]=s,y[7]=r,y[8]=a):a=y[8];let I=_.language||"text";return y[9]!==I?(c=(0,t.jsx)("span",{className:"text-sm text-gray-400 font-mono",children:I}),y[9]=I,y[10]=c):c=y[10],y[11]!==h?(l=h?(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M5 13l4 4L19 7"})}),"已复制"]}):(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"})}),"复制代码"]}),y[11]=h,y[12]=l):l=y[12],y[13]!==k||y[14]!==l?(p=(0,t.jsx)("button",{onClick:k,className:"flex items-center gap-1.5 px-3 py-1 text-sm text-gray-300 hover:text-white bg-gray-700 hover:bg-gray-600 rounded transition-colors",children:l}),y[13]=k,y[14]=l,y[15]=p):p=y[15],y[16]!==c||y[17]!==p?(d=(0,t.jsxs)("div",{className:"flex items-center justify-between px-4 py-2 bg-gray-800 border-b border-gray-700",children:[c,p]}),y[16]=c,y[17]=p,y[18]=d):d=y[18],y[19]!==_.code?(m=(0,t.jsx)("pre",{className:"p-4 overflow-x-auto",children:(0,t.jsx)("code",{className:"text-sm text-gray-100 font-mono whitespace-pre",children:_.code})}),y[19]=_.code,y[20]=m):m=y[20],y[21]!==d||y[22]!==m?(u=(0,t.jsxs)("div",{className:"bg-gray-900 rounded-xl overflow-hidden",children:[d,m]}),y[21]=d,y[22]=m,y[23]=u):u=y[23],y[24]!==_.content?(g=_.content&&(0,t.jsx)("div",{className:"mt-4 p-4 bg-gray-50 rounded-lg",children:(0,t.jsx)("p",{className:"text-sm text-gray-700",children:_.content})}),y[24]=_.content,y[25]=g):g=y[25],y[26]!==u||y[27]!==g||y[28]!==a?(f=(0,t.jsxs)("div",{className:"mb-8",children:[a,u,g]}),y[26]=u,y[27]=g,y[28]=a,y[29]=f):f=y[29],f},"ConceptSection",0,function(e){let o,i,s,r,a,c,l,p,d=(0,n.c)(19),{section:m,index:u}=e,g=u+1;return d[0]!==g?(o=(0,t.jsx)("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-sm",children:g}),d[0]=g,d[1]=o):o=d[1],d[2]!==m.title?(i=(0,t.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:m.title}),d[2]=m.title,d[3]=i):i=d[3],d[4]!==o||d[5]!==i?(s=(0,t.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[o,i]}),d[4]=o,d[5]=i,d[6]=s):s=d[6],d[7]!==m.content?(r=m.content.split("\n\n").map(S),d[7]=m.content,d[8]=r):r=d[8],d[9]!==r?(a=(0,t.jsx)("div",{className:"prose prose-gray max-w-none",children:r}),d[9]=r,d[10]=a):a=d[10],d[11]!==m.keyPoint?(c=m.keyPoint&&(0,t.jsx)("div",{className:"mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200",children:(0,t.jsxs)("div",{className:"flex items-start gap-2",children:[(0,t.jsx)("svg",{className:"w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"})}),(0,t.jsx)("p",{className:"text-sm text-blue-900 font-medium",children:m.keyPoint})]})}),d[11]=m.keyPoint,d[12]=c):c=d[12],d[13]!==a||d[14]!==c?(l=(0,t.jsxs)("div",{className:"bg-white rounded-xl p-6 border border-gray-200",children:[a,c]}),d[13]=a,d[14]=c,d[15]=l):l=d[15],d[16]!==s||d[17]!==l?(p=(0,t.jsxs)("div",{className:"mb-8",children:[s,l]}),d[16]=s,d[17]=l,d[18]=p):p=d[18],p},"ExampleSection",0,function(e){let o,i,s,r,a,c,l,p=(0,n.c)(15),{section:d,index:m}=e,u=m+1;return p[0]!==u?(o=(0,t.jsx)("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-white font-bold text-sm",children:u}),p[0]=u,p[1]=o):o=p[1],p[2]!==d.title?(i=(0,t.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:d.title}),p[2]=d.title,p[3]=i):i=p[3],p[4]!==o||p[5]!==i?(s=(0,t.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[o,i]}),p[4]=o,p[5]=i,p[6]=s):s=p[6],p[7]===Symbol.for("react.memo_cache_sentinel")?(r=(0,t.jsx)("svg",{className:"w-6 h-6 text-amber-600 flex-shrink-0 mt-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"})}),p[7]=r):r=p[7],p[8]!==d.content?(a=d.content.split("\n\n").map(N),p[8]=d.content,p[9]=a):a=p[9],p[10]!==a?(c=(0,t.jsx)("div",{className:"bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-6 border border-amber-200",children:(0,t.jsxs)("div",{className:"flex items-start gap-3 mb-4",children:[r,(0,t.jsx)("div",{className:"prose prose-gray max-w-none",children:a})]})}),p[10]=a,p[11]=c):c=p[11],p[12]!==s||p[13]!==c?(l=(0,t.jsxs)("div",{className:"mb-8",children:[s,c]}),p[12]=s,p[13]=c,p[14]=l):l=p[14],l},"IntroductionSection",0,function(e){let o,i,s,r,a,c,l=(0,n.c)(14),{section:p,index:d}=e,m=d+1;return l[0]!==m?(o=(0,t.jsx)("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white font-bold text-sm",children:m}),l[0]=m,l[1]=o):o=l[1],l[2]!==p.title?(i=(0,t.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:p.title}),l[2]=p.title,l[3]=i):i=l[3],l[4]!==o||l[5]!==i?(s=(0,t.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[o,i]}),l[4]=o,l[5]=i,l[6]=s):s=l[6],l[7]!==p.content?(r=p.content.split("\n\n").map(j),l[7]=p.content,l[8]=r):r=l[8],l[9]!==r?(a=(0,t.jsx)("div",{className:"bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-6 border border-emerald-200",children:(0,t.jsx)("div",{className:"prose prose-gray max-w-none",children:r})}),l[9]=r,l[10]=a):a=l[10],l[11]!==s||l[12]!==a?(c=(0,t.jsxs)("div",{className:"mb-8",children:[s,a]}),l[11]=s,l[12]=a,l[13]=c):c=l[13],c},"NoteSection",0,function(e){let o,i,s,r,a,c,l=(0,n.c)(13),{section:p,index:d}=e,m=d+1;return l[0]!==m?(o=(0,t.jsx)("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-white font-bold text-sm",children:m}),l[0]=m,l[1]=o):o=l[1],l[2]!==p.title?(i=(0,t.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:p.title}),l[2]=p.title,l[3]=i):i=l[3],l[4]!==o||l[5]!==i?(s=(0,t.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[o,i]}),l[4]=o,l[5]=i,l[6]=s):s=l[6],l[7]===Symbol.for("react.memo_cache_sentinel")?(r=(0,t.jsx)("svg",{className:"w-5 h-5 text-cyan-600 flex-shrink-0 mt-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"})}),l[7]=r):r=l[7],l[8]!==p.content?(a=(0,t.jsx)("div",{className:"bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl p-6 border border-cyan-200",children:(0,t.jsxs)("div",{className:"flex items-start gap-3",children:[r,(0,t.jsx)("p",{className:"text-sm text-cyan-900",children:p.content})]})}),l[8]=p.content,l[9]=a):a=l[9],l[10]!==s||l[11]!==a?(c=(0,t.jsxs)("div",{className:"mb-8",children:[s,a]}),l[10]=s,l[11]=a,l[12]=c):c=l[12],c},"SummarySection",0,function(e){let o,i,s,r,a,c,l=(0,n.c)(13),{section:p,index:d}=e,m=d+1;return l[0]!==m?(o=(0,t.jsx)("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-purple-500 to-violet-600 flex items-center justify-center text-white font-bold text-sm",children:m}),l[0]=m,l[1]=o):o=l[1],l[2]!==p.title?(i=(0,t.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:p.title}),l[2]=p.title,l[3]=i):i=l[3],l[4]!==o||l[5]!==i?(s=(0,t.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[o,i]}),l[4]=o,l[5]=i,l[6]=s):s=l[6],l[7]===Symbol.for("react.memo_cache_sentinel")?(r=(0,t.jsx)("svg",{className:"w-6 h-6 text-purple-600 flex-shrink-0 mt-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"})}),l[7]=r):r=l[7],l[8]!==p.content?(a=(0,t.jsx)("div",{className:"bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl p-6 border border-purple-200",children:(0,t.jsxs)("div",{className:"flex items-start gap-3",children:[r,(0,t.jsx)("div",{className:"flex-1",children:(0,t.jsx)("p",{className:"text-purple-900 font-medium mb-4",children:p.content})})]})}),l[8]=p.content,l[9]=a):a=l[9],l[10]!==s||l[11]!==a?(c=(0,t.jsxs)("div",{className:"mb-8",children:[s,a]}),l[10]=s,l[11]=a,l[12]=c):c=l[12],c},"WarningSection",0,function(e){let o,i,s,r,a,c,l,p=(0,n.c)(14),{section:d,index:m}=e,u=m+1;return p[0]!==u?(o=(0,t.jsx)("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-red-500 to-rose-600 flex items-center justify-center text-white font-bold text-sm",children:u}),p[0]=u,p[1]=o):o=p[1],p[2]!==d.title?(i=(0,t.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:d.title}),p[2]=d.title,p[3]=i):i=p[3],p[4]!==o||p[5]!==i?(s=(0,t.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[o,i]}),p[4]=o,p[5]=i,p[6]=s):s=p[6],p[7]===Symbol.for("react.memo_cache_sentinel")?(r=(0,t.jsx)("svg",{className:"w-5 h-5 text-red-600 flex-shrink-0 mt-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,t.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0zM12 9v4m0 4h.01"})}),a=(0,t.jsx)("h3",{className:"text-sm font-semibold text-red-900 mb-2",children:"重要提醒"}),p[7]=r,p[8]=a):(r=p[7],a=p[8]),p[9]!==d.content?(c=(0,t.jsx)("div",{className:"bg-gradient-to-r from-red-50 to-rose-50 rounded-xl p-6 border border-red-200",children:(0,t.jsxs)("div",{className:"flex items-start gap-3",children:[r,(0,t.jsxs)("div",{children:[a,(0,t.jsx)("p",{className:"text-sm text-red-800",children:d.content})]})]})}),p[9]=d.content,p[10]=c):c=p[10],p[11]!==s||p[12]!==c?(l=(0,t.jsxs)("div",{className:"mb-8",children:[s,c]}),p[11]=s,p[12]=c,p[13]=l):l=p[13],l},"default",0,C],65832)}]);