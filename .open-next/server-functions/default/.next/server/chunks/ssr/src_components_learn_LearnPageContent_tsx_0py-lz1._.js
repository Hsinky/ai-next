...
- 记录每次工具调用的参数与结果
- 保存用户请求和系统响应，用于追责
- 保留日志至少30天`},{type:"note",title:"成本与安全",content:"控制调用频率、设置权限、加密传输，以及按需扩缩容，是部署MCP时的常见策略。"}],summary:"企业级MCP部署需要关注高可用、监控、审计、安全和成本。通过冗余架构、日志审计和权限控制，才能在生产环境稳健运行。",keyPoints:["高可用架构包含冗余、负载均衡与故障切换","监控指标：响应时间、成功率、异常日志","审计记录请求/响应并保存30天以上"],exercises:[{type:"choice",question:"企业级MCP部署时，哪个要素最重要？",options:["颜色主题","高可用架构、监控与审计","更大的模型","把所有逻辑写在前端"],answer:"高可用架构、监控与审计",explanation:"部署MCP时，确保高可用和能够监控/审计是根本。"},{type:"choice",question:"MCP审计日志至少保留多久？",options:["1天","7天","30天","永远不删除"],answer:"30天",explanation:"审计日志需要保留下至少30天，便于追踪和合规。"}]}},n={"workflow-principles":{id:"workflow-principles",title:"工作流设计原则",subtitle:"学会设计可理解、可维护的AI工作流",duration:40,difficulty:"intermediate",tags:["Workflow","设计原则"],objectives:["理解工作流设计的核心原则","掌握流程控制和分支的基本方法","学会设计可复用的工作流模块"],sections:[{type:"introduction",title:"开篇：什么时候需要工作流？",content:"当单次AI回复不能完成多步任务时，就需要工作流。它通过一系列节点、分支和条件，让AI按既定流程执行任务，具备可维护和可观测性。"},{type:"concept",title:"设计原则一：原子性与可组合",content:`**原子性**：每个节点做一件事，如"查询用户"、"写报告"。职责清晰便于测试。
...
**聊天记录** → 按会话分割（每个对话独立）`}],summary:"文档切分策略包括固定长度、语义分割和滑动窗口。固定长度简单但可能割裂语义，语义分割保持完整但长度不一，滑动窗口通过重叠保证连续性。应根据文档类型选择合适策略。",keyPoints:["固定长度切分：简单，但可能割裂语义","语义切分：保持段落、句子完整，适合结构化文档","滑动窗口：片段有重叠，保证关键信息不断开","根据文档类型选择策略"],exercises:[{type:"choice",question:"滑动窗口切分的主要优势是？",options:["实现最简单","片段长度完全一致","片段之间有重叠，保证关键信息不被截断","不需要额外内存"],answer:"片段之间有重叠，保证关键信息不被截断",explanation:"滑动窗口让相邻片段有重叠，避免关键词被边界切断。"},{type:"choice",question:"哪种文档最适合用语义分割？",options:["无结构的长文本","有明确标题和结构的Markdown文档","代码片段","纯数字数据"],answer:"有明确标题和结构的Markdown文档",explanation:"语义分割利用文档的自然边界（标题、段落），对结构化文档效果好。"}]}},p={"rag-retrieval":{id:"rag-retrieval",title:"检索优化与重排序",subtitle:"提升RAG检索质量的实战技巧",duration:45,difficulty:"intermediate",tags:["RAG","检索优化","重排序"],objectives:["掌握检索质量优化的核心方法","学会使用重排序提升结果相关性","了解混合检索策略"],sections:[{type:"introduction",title:"开篇：为什么检索质量决定RAG效果",content:"RAG的效果上限由检索质量决定。如果检索到的文档不相关，即使最好的生成模型也无法给出正确答案。本节课我们将学习如何优化检索环节。"},{type:"concept",title:"检索优化的核心问题",content:`**问题一：语义鸿沟**
...
- 与监管机构保持沟通
- 参与行业自律组织
- 建立用户信任`},{type:"note",title:"治理是竞争优势",content:"良好的AI治理不是负担，而是竞争优势。它能降低合规风险、提升用户信任、获得监管认可，为企业长期发展奠定基础。"}],summary:"AI治理框架包括原则政策、流程控制、人员文化三大支柱。主要法规包括中国的生成式AI管理办法、个人信息保护法，欧盟AI法案等。企业需要建立治理委员会、风险评估机制、持续改进流程。",keyPoints:["AI治理三大支柱：原则政策、流程控制、人员文化","主要法规：中国生成式AI管理办法、欧盟AI法案、美国NIST框架","企业治理体系：委员会+安全团队+合规团队","持续治理：定期评估、事件响应、政策更新、对外沟通"],exercises:[{type:"choice",question:"欧盟AI法案禁止的AI类别不包括？",options:["社会评分系统","实时生物识别监控","邮件分类","潜意识操纵"],answer:"邮件分类",explanation:"欧盟AI法案禁止的是社会评分、实时生物识别监控等高风险AI。邮件分类属于有限风险或最小风险AI。"},{type:"choice",question:"AI风险评估应该何时进行？",options:["只在产品发布前","只在出现问题时","贯穿项目全生命周期，定期评估","不需要风险评估"],answer:"贯穿项目全生命周期，定期评估",explanation:"AI风险评估应该贯穿项目全生命周期，从开发到发布再到运行，都需要定期评估和监控。"}]}},w="ai_academy_learning_progress";function x(){let{data:a,getCompletedCount:c}=function(){let[a,b]=(0,d.useState)(null);return(0,d.useEffect)(()=>{let a=localStorage.getItem(w);if(a)try{b(JSON.parse(a))}catch{}},[]),{data:a,updateProgress:(a,c)=>{b(b=>{let d={userId:b?.userId||"anonymous",progress:{...b?.progress,[a]:{lessonId:a,completed:c.completed??b?.progress[a]?.completed??!1,completedAt:c.completed?new Date().toISOString():void 0,lastPosition:c.lastPosition??b?.progress[a]?.lastPosition,notes:c.notes??b?.progress[a]?.notes,bookmarks:c.bookmarks??b?.progress[a]?.bookmarks}},totalTime:b?.totalTime??0,streak:b?.streak??0,lastStudyDate:new Date().toISOString().split("T")[0]};return localStorage.setItem(w,JSON.stringify(d)),d})},getProgress:b=>a?.progress[b],getCompletedCount:()=>Object.values(a?.progress||{}).filter(a=>a.completed).length}}();return(0,b.jsxs)("div",{className:"bg-white rounded-xl border border-gray-200 p-6",children:[(0,b.jsx)("h3",{className:"font-semibold text-gray-900 mb-4",children:"学习统计"}),(0,b.jsxs)("div",{className:"grid grid-cols-2 gap-4",children:[(0,b.jsxs)("div",{className:"p-4 bg-blue-50 rounded-lg",children:[(0,b.jsx)("p",{className:"text-2xl font-bold text-blue-600",children:c()}),(0,b.jsx)("p",{className:"text-sm text-blue-700",children:"已完成课程"})]}),(0,b.jsxs)("div",{className:"p-4 bg-purple-50 rounded-lg",children:[(0,b.jsx)("p",{className:"text-2xl font-bold text-purple-600",children:a?.streak??0}),(0,b.jsx)("p",{className:"text-sm text-purple-700",children:"连续学习天数"})]}),(0,b.jsxs)("div",{className:"p-4 bg-emerald-50 rounded-lg",children:[(0,b.jsx)("p",{className:"text-2xl font-bold text-emerald-600",children:Math.floor((a?.totalTime??0)/60)}),(0,b.jsx)("p",{className:"text-sm text-emerald-700",children:"学习小时数"})]}),(0,b.jsxs)("div",{className:"p-4 bg-orange-50 rounded-lg",children:[(0,b.jsx)("p",{className:"text-2xl font-bold text-orange-600",children:Object.keys(a?.progress??{}).length}),(0,b.jsx)("p",{className:"text-sm text-orange-700",children:"学习课程数"})]})]})]})}function y(){let a=Object.values(f);return(0,b.jsxs)("div",{className:"bg-white rounded-xl border border-gray-200 p-6",children:[(0,b.jsx)("h3",{className:"font-semibold text-gray-900 mb-4",children:"学习路线图"}),(0,b.jsx)("div",{className:"space-y-4",children:a.map((d,e)=>(0,b.jsxs)("div",{className:"relative",children:[e<a.length-1&&(0,b.jsx)("div",{className:"absolute left-5 top-12 w-0.5 h-8 bg-gray-200"}),(0,b.jsxs)("div",{className:"flex items-start gap-4",children:[(0,b.jsx)("div",{className:`w-10 h-10 rounded-lg bg-gradient-to-r ${d.gradient} flex items-center justify-center text-white font-bold flex-shrink-0`,children:d.icon}),(0,b.jsxs)("div",{className:"flex-1",children:[(0,b.jsx)("h4",{className:"font-medium text-gray-900",children:d.title}),(0,b.jsx)("p",{className:"text-sm text-gray-500 mb-2",children:d.description}),(0,b.jsx)("div",{className:"flex flex-wrap gap-2",children:d.modules.map(a=>{let d=g[a];return(0,b.jsx)(c.default,{href:`/learn/module/${a}`,className:"text-xs px-2 py-1 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded transition-colors",children:d?.title??a},a)})})]})]})]},d.id))})]})}let z=Object.values(f);function A(){let[a,f]=(0,d.useState)("stages");return(0,b.jsxs)("div",{className:"p-8",children:[(0,b.jsxs)("div",{className:"mb-8",children:[(0,b.jsxs)("h1",{className:"text-3xl font-bold text-gray-900 mb-2 flex items-center",children:[(0,b.jsx)("span",{className:"mr-2",children:"📚"}),"AI博士学院"]}),(0,b.jsx)("p",{className:"text-gray-600",children:"系统学习 AI 能力平台，从入门到精通的完整学习路径"})]}),(0,b.jsx)("div",{className:"flex gap-2 mb-8",children:[{key:"stages",label:"学习阶段"},{key:"modules",label:"课程模块"},{key:"progress",label:"学习进度"}].map(c=>(0,b.jsx)("button",{onClick:()=>f(c.key),className:`px-4 py-2 rounded-lg font-medium transition-colors ${a===c.key?"bg-blue-600 text-white":"bg-gray-100 text-gray-600 hover:bg-gray-200"}`,children:c.label},c.key))}),"stages"===a&&(0,b.jsx)("div",{className:"grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6",children:z.map(a=>(0,b.jsxs)(c.default,{href:`/learn/path/${a.id}`,className:"group bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg hover:border-gray-300 transition-all",children:[(0,b.jsx)("div",{className:`bg-linear-to-r ${a.gradient} p-4 text-white`,children:(0,b.jsxs)("div",{className:"flex items-center gap-3",children:[(0,b.jsx)("div",{className:"w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center text-xl",children:a.icon}),(0,b.jsxs)("div",{children:[(0,b.jsx)("h3",{className:"font-bold",children:a.title}),(0,b.jsx)("p",{className:"text-sm text-white/80",children:a.subtitle})]})]})}),(0,b.jsx)("div",{className:"p-4 border-b border-gray-100",children:(0,b.jsx)("p",{className:"text-sm text-gray-600",children:a.description})}),(0,b.jsx)("div",{className:"p-4",children:(0,b.jsx)("div",{className:"space-y-2",children:a.modules.map(a=>{let c=g[a];return(0,b.jsxs)("div",{className:"flex items-center gap-2 text-sm",children:[(0,b.jsx)("span",{className:"w-5 h-5 rounded bg-gray-100 text-gray-500 text-xs flex items-center justify-center",children:c?.icon??"📚"}),(0,b.jsx)("span",{className:"text-gray-700",children:c?.title??a})]},a)})})})]},a.id))}),"modules"===a&&(0,b.jsx)("div",{className:"space-y-8",children:z.map(a=>(0,b.jsxs)("div",{children:[(0,b.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[(0,b.jsx)("div",{className:`w-8 h-8 rounded-lg bg-linear-to-r ${a.gradient} flex items-center justify-center text-white`,children:a.icon}),(0,b.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:a.title})]}),(0,b.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4",children:a.modules.map(a=>{let d=g[a],f=function(a){let b,c=(Object.assign(b={},h),Object.assign(b,i),Object.assign(b,j),Object.assign(b,k),Object.assign(b,l),Object.assign(b,m),Object.assign(b,n),Object.assign(b,o),Object.assign(b,p),Object.assign(b,q),Object.assign(b,r),Object.assign(b,s),Object.assign(b,t),Object.assign(b,u),Object.assign(b,v),b),d=[];for(let b of Object.values(c))b.id.startsWith(a)&&d.push(b);return d.sort((a,b)=>a.id.localeCompare(b.id))}(a),w=e[d?.difficulty??"beginner"];return(0,b.jsxs)("div",{className:"bg-white rounded-xl border border-gray-200 overflow-hidden",children:[(0,b.jsx)("div",{className:`bg-linear-to-r ${d?.color??"from-gray-500 to-gray-600"} p-4 text-white`,children:(0,b.jsxs)("div",{className:"flex items-center gap-3",children:[(0,b.jsx)("div",{className:"w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center text-xl",children:d?.icon??"📚"}),(0,b.jsxs)("div",{children:[(0,b.jsx)("h3",{className:"font-bold",children:d?.title??a}),(0,b.jsxs)("p",{className:"text-xs text-white/80",children:[f.length,"节课"]})]})]})}),(0,b.jsxs)("div",{className:"p-4",children:[(0,b.jsx)("p",{className:"text-sm text-gray-600 mb-3",children:d?.description}),(0,b.jsxs)("div",{className:"flex items-center justify-between",children:[(0,b.jsx)("span",{className:`px-2 py-0.5 rounded text-xs font-medium ${w.bgColor} ${w.color}`,children:w.label}),(0,b.jsx)(c.default,{href:`/learn/module/${a}`,className:"text-sm text-blue-600 hover:text-blue-700",children:"查看课程 →"})]})]})]},a)})})]},a.id))}),"progress"===a&&(0,b.jsxs)("div",{className:"grid grid-cols-1 lg:grid-cols-2 gap-6",children:[(0,b.jsxs)("div",{className:"space-y-6",children:[(0,b.jsx)(x,{}),(0,b.jsx)(y,{})]}),(0,b.jsxs)("div",{className:"bg-white rounded-xl border border-gray-200 p-6",children:[(0,b.jsx)("h3",{className:"font-semibold text-gray-900 mb-4",children:"学习建议"}),(0,b.jsxs)("div",{className:"space-y-4",children:[(0,b.jsxs)("div",{className:"p-4 bg-blue-50 rounded-lg border border-blue-200",children:[(0,b.jsx)("h4",{className:"font-medium text-blue-900 mb-2",children:"🎯 新手入门"}),(0,b.jsx)("p",{className:"text-sm text-blue-800",children:"建议从「AI本质与原理」开始，建立正确的AI认知，理解AI的真实工作方式。"}),(0,b.jsx)(c.default,{href:"/learn/lesson/ai-what-is",className:"mt-3 inline-block text-sm text-blue-600 hover:text-blue-700",children:"开始学习 →"})]}),(0,b.jsxs)("div",{className:"p-4 bg-green-50 rounded-lg border border-green-200",children:[(0,b.jsx)("h4",{className:"font-medium text-green-900 mb-2",children:"📚 系统学习"}),(0,b.jsx)("p",{className:"text-sm text-green-800",children:"按照阶段顺序学习：基础认知 → Prompt工程 → Agent开发 → RAG知识库 → 生产实践"})]}),(0,b.jsxs)("div",{className:"p-4 bg-purple-50 rounded-lg border border-purple-200",children:[(0,b.jsx)("h4",{className:"font-medium text-purple-900 mb-2",children:"💡 学习技巧"}),(0,b.jsx)("p",{className:"text-sm text-purple-800",children:"每节课都配有代码示例和练习题，动手实践是掌握知识的关键。"})]})]})]})]}),(0,b.jsx)("div",{className:"mt-12 bg-linear-to-r from-blue-500 to-indigo-600 rounded-2xl p-8 text-white",children:(0,b.jsxs)("div",{className:"flex items-center justify-between",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("h2",{className:"text-2xl font-bold mb-2",children:"开始你的AI学习之旅"}),(0,b.jsx)("p",{className:"text-white/80",children:"从基础认知开始，逐步掌握AI应用开发的核心技能"})]}),(0,b.jsx)(c.default,{href:"/learn/lesson/ai-what-is",className:"px-6 py-3 bg-white text-blue-600 rounded-xl font-medium hover:bg-blue-50 transition-colors",children:"开始学习"})]})})]})}a.s(["default",0,A],91221),a.i(91221),a.s(["CodeSection",0,function({section:a,index:c}){let[e,f]=(0,d.useState)(!1),g=async()=>{a.code&&(await navigator.clipboard.writeText(a.code),f(!0),setTimeout(()=>f(!1),2e3))};return(0,b.jsxs)("div",{className:"mb-8",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[(0,b.jsx)("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm",children:c+1}),(0,b.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:a.title})]}),(0,b.jsxs)("div",{className:"bg-gray-900 rounded-xl overflow-hidden",children:[(0,b.jsxs)("div",{className:"flex items-center justify-between px-4 py-2 bg-gray-800 border-b border-gray-700",children:[(0,b.jsx)("span",{className:"text-sm text-gray-400 font-mono",children:a.language||"text"}),(0,b.jsx)("button",{onClick:g,className:"flex items-center gap-1.5 px-3 py-1 text-sm text-gray-300 hover:text-white bg-gray-700 hover:bg-gray-600 rounded transition-colors",children:e?(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M5 13l4 4L19 7"})}),"已复制"]}):(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"})}),"复制代码"]})})]}),(0,b.jsx)("pre",{className:"p-4 overflow-x-auto",children:(0,b.jsx)("code",{className:"text-sm text-gray-100 font-mono whitespace-pre",children:a.code})})]}),a.content&&(0,b.jsx)("div",{className:"mt-4 p-4 bg-gray-50 rounded-lg",children:(0,b.jsx)("p",{className:"text-sm text-gray-700",children:a.content})})]})},"ConceptSection",0,function({section:a,index:c}){return(0,b.jsxs)("div",{className:"mb-8",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[(0,b.jsx)("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-sm",children:c+1}),(0,b.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:a.title})]}),(0,b.jsxs)("div",{className:"bg-white rounded-xl p-6 border border-gray-200",children:[(0,b.jsx)("div",{className:"prose prose-gray max-w-none",children:a.content.split("\n\n").map((a,c)=>(0,b.jsx)("p",{className:"text-gray-700 leading-relaxed mb-4 last:mb-0",children:a},c))}),a.keyPoint&&(0,b.jsx)("div",{className:"mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200",children:(0,b.jsxs)("div",{className:"flex items-start gap-2",children:[(0,b.jsx)("svg",{className:"w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"})}),(0,b.jsx)("p",{className:"text-sm text-blue-900 font-medium",children:a.keyPoint})]})})]})]})},"ExampleSection",0,function({section:a,index:c}){return(0,b.jsxs)("div",{className:"mb-8",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[(0,b.jsx)("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-white font-bold text-sm",children:c+1}),(0,b.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:a.title})]}),(0,b.jsx)("div",{className:"bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-6 border border-amber-200",children:(0,b.jsxs)("div",{className:"flex items-start gap-3 mb-4",children:[(0,b.jsx)("svg",{className:"w-6 h-6 text-amber-600 flex-shrink-0 mt-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"})}),(0,b.jsx)("div",{className:"prose prose-gray max-w-none",children:a.content.split("\n\n").map((a,c)=>(0,b.jsx)("p",{className:"text-gray-700 leading-relaxed mb-4 last:mb-0",children:a},c))})]})})]})},"IntroductionSection",0,function({section:a,index:c}){return(0,b.jsxs)("div",{className:"mb-8",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[(0,b.jsx)("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white font-bold text-sm",children:c+1}),(0,b.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:a.title})]}),(0,b.jsx)("div",{className:"bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-6 border border-emerald-200",children:(0,b.jsx)("div",{className:"prose prose-gray max-w-none",children:a.content.split("\n\n").map((a,c)=>(0,b.jsx)("p",{className:"text-gray-700 leading-relaxed mb-4 last:mb-0",children:a},c))})})]})},"NoteSection",0,function({section:a,index:c}){return(0,b.jsxs)("div",{className:"mb-8",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[(0,b.jsx)("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-white font-bold text-sm",children:c+1}),(0,b.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:a.title})]}),(0,b.jsx)("div",{className:"bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl p-6 border border-cyan-200",children:(0,b.jsxs)("div",{className:"flex items-start gap-3",children:[(0,b.jsx)("svg",{className:"w-5 h-5 text-cyan-600 flex-shrink-0 mt-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"})}),(0,b.jsx)("p",{className:"text-sm text-cyan-900",children:a.content})]})})]})},"SummarySection",0,function({section:a,index:c}){return(0,b.jsxs)("div",{className:"mb-8",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[(0,b.jsx)("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-purple-500 to-violet-600 flex items-center justify-center text-white font-bold text-sm",children:c+1}),(0,b.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:a.title})]}),(0,b.jsx)("div",{className:"bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl p-6 border border-purple-200",children:(0,b.jsxs)("div",{className:"flex items-start gap-3",children:[(0,b.jsx)("svg",{className:"w-6 h-6 text-purple-600 flex-shrink-0 mt-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"})}),(0,b.jsx)("div",{className:"flex-1",children:(0,b.jsx)("p",{className:"text-purple-900 font-medium mb-4",children:a.content})})]})})]})},"WarningSection",0,function({section:a,index:c}){return(0,b.jsxs)("div",{className:"mb-8",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[(0,b.jsx)("div",{className:"w-8 h-8 rounded-lg bg-gradient-to-br from-red-500 to-rose-600 flex items-center justify-center text-white font-bold text-sm",children:c+1}),(0,b.jsx)("h2",{className:"text-xl font-bold text-gray-900",children:a.title})]}),(0,b.jsx)("div",{className:"bg-gradient-to-r from-red-50 to-rose-50 rounded-xl p-6 border border-red-200",children:(0,b.jsxs)("div",{className:"flex items-start gap-3",children:[(0,b.jsx)("svg",{className:"w-5 h-5 text-red-600 flex-shrink-0 mt-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0zM12 9v4m0 4h.01"})}),(0,b.jsxs)("div",{children:[(0,b.jsx)("h3",{className:"text-sm font-semibold text-red-900 mb-2",children:"重要提醒"}),(0,b.jsx)("p",{className:"text-sm text-red-800",children:a.content})]})]})})]})},"default",0,A],33609)}];

//# sourceMappingURL=src_components_learn_LearnPageContent_tsx_0py-lz1._.js.map